...
st_velocity velocity6 = { 0,  0,  0 };
st_velocity velocity5 = { 1,  5,  0, &velocity6 };
st_velocity velocity4 = { 2,  5,  0, &velocity5 };
st_velocity velocity3 = { 5,  5,  0, &velocity4 };
st_velocity velocity2 = { 10, 5,  0, &velocity3 };
st_velocity velocity1 = { 40, 1,  0, &velocity2 };
